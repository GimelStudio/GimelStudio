...
void Dispatcher::dispatch(String actionCode, VariantMap actionData)
{
...
void Dispatcher::dispatch(Variant actionCode, VariantMap actionData)
{
    dispatch(actionCode.toString(), actionData);
}
